...
var iPhoneSimulator = (function () {
    ...
    iPhoneSimulator.prototype.printSDKS = function () {
        var _this = this;
        var action = function () {
            var sdks = _this.getInstalledSdks();
...
=======
        console.log("SDK VERSION IN IOS-SIM-PORTABLE!!!!!");
        console.log(options.sdkVersion);
        console.log("DEFAULT ROOT!!!");
        console.log(this.getClassByName("DTiPhoneSimulatorSystemRoot")("defaultRoot"));
>>>>>>> Some .js changes
    ...
    iPhoneSimulator.prototype.getInstalledSdks = function () {
    ...
    iPhoneSimulator.prototype.getSdkRootPathByVersion = function (version) {
